    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Personaliza cómo el bot responde a los clientes de este taller.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-6">
            <Accordion type="multiple" defaultValue={['workshop', 'general', 'services', 'faq']} className="w-full">
              ...
              <AccordionItem value="workshop">
                ...
                <AccordionContent className="space-y-4 pt-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="booking_url"
                      placeholder="https://autonomiasuite.lovable.app/agenda/mi-taller"
                      value={bookingUrl}
                      onChange={(e) => setBookingUrl(e.target.value)}
                    />
                    <p className="text-xs text-muted-foreground">
                      URL completa donde el bot enviará a los clientes para agendar. Ejemplo: https://autonomiasuite.lovable.app/agenda/mi-taller
                    </p>
                  </div>
                </AccordionContent>
              </AccordionItem>
                ...
                <AccordionContent className="space-y-4 pt-4">
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder="Somos un taller especializado en mantención y reparación de vehículos..."
                      value={businessDescription}
                      onChange={(e) => setBusinessDescription(e.target.value)}
                      rows={3}
                    />
                    <p className="text-xs text-muted-foreground">
                      El bot usará esta información para describir el taller.
                    </p>
                  </div>
              ...
              <AccordionItem value="services">
                ...
                <AccordionContent className="space-y-4 pt-4">
                  <p className="text-xs text-muted-foreground">
                    Lista de servicios que ofrece el taller. El bot podrá informar precios y descripciones.
                  </p>
